/**
 * Configuração do ThingSpeak para o dashboard ClimaControl.
 *
  ...
  if (useMockData) {
    console.info(
      mockReason === "flag"
        ...
        : "[ClimaControl] ThingSpeak não configurado — modo simulação ativo."
    );
  } else {
    console.info(
      `[ClimaControl] Lendo canal ThingSpeak ${thingSpeakConfig.channelId}` +
        (controlEnabled
